...
/*Data for the table `customer_collect` */
...
CREATE TABLE `order_info` (
  ...
  `cargo_price` float(9,2) NOT NULL DEFAULT '0.00' COMMENT '运费',
  `total_price` float(9,2) NOT NULL DEFAULT '0.00' COMMENT '总费用',
  `modify_cargo_price` float(9,2) DEFAULT '0.00' COMMENT '修改后运费',
  `modify_total_price` float(9,2) DEFAULT '0.00' COMMENT '修改后的总费用',
  ...
  `address` varchar(200) DEFAULT NULL COMMENT '具体位置',
  `phone` varchar(50) NOT NULL DEFAULT '0' COMMENT '电话号码',
  `need_cargo` int(2) DEFAULT NULL COMMENT '需要物流 0:需要 1:不需要',
  ...
  `cargo_time` timestamp NULL DEFAULT NULL COMMENT '发货时间',
  `confirm_cargo_time` timestamp NULL DEFAULT NULL COMMENT '确认收货时间',
  `create_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `last_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
insert  into `order_info`(`id`,`customer_id`,`user_id`,`biz_id`,`product_price`,`cargo_price`,`total_price`,`modify_cargo_price`,`modify_total_price`,`status`,`receiver`,`post_code`,`province`,`city`,`region`,`address`,`phone`,`need_cargo`,`cargo_name`,`cargo_number`,`iseff`,`pay_time`,`cargo_time`,`confirm_cargo_time`,`create_time`,`last_update`) values (1,8,10,'NO111121',0.00,0.00,100.11,0.00,0.00,'0','林生',NULL,'广东省','广州','海珠区','赤岗','13826031714',NULL,NULL,NULL,'1',NULL,NULL,NULL,'2016-02-16 15:39:11','2016-02-18 18:17:23'),(2,8,10,'NO222222',0.00,0.00,100.00,0.00,0.00,'2','黄生',NULL,'广东省','广州','荔湾区','芳村','13826031714',NULL,'','','1',NULL,'2016-02-23 17:57:19',NULL,'2016-02-14 15:39:11','2016-02-23 17:57:19');
...
insert  into `web_resource`(`id`,`user_id`,`name`,`template_id`,`category_id`,`tag_id`,`image_url`,`short_desc`,`long_desc`,`cost`,`price`,`unit`,`weight`,`gift_score`,`stock_num`,`brand_id`,`promotion_type`,`is_online`,`is_hot`,`need_carry`,`remark`,`search_keyword`,`page_title`,`page_keyword`,`page_desc`,`iseff`,`create_time`,`last_update`,`is_show`,`is_top`,`is_host`) values (7,10,'红蟹王',NULL,13,NULL,'/fileupload/Fg_cNErXDhMCDcEprN51ZiBGSLjV1455791428609.gif','222',NULL,50.00,30.00,'1',NULL,NULL,10,NULL,NULL,0,0,1,NULL,NULL,NULL,NULL,NULL,'1','2015-10-11 22:16:01','2016-02-24 18:29:38',NULL,NULL,NULL),(8,10,'红蟹王',NULL,13,NULL,'/fileupload/Flf7f_-r8pa91RP4ne6b-0ac_ub-1455791446659.gif','多肉新鲜红蟹王',NULL,11.00,11111.08,'1',NULL,NULL,10,NULL,NULL,1,0,1,NULL,NULL,NULL,NULL,NULL,'1','2015-10-11 23:17:42','2016-02-18 18:30:48',NULL,NULL,NULL),(9,10,'老虎虾',5,11,NULL,'/fileupload/FpMAINiYaGaBKm41Owd1F5Vfw2bx1454493962406.gif','马来西亚空运老虎虾',NULL,NULL,NULL,'22','1',NULL,1,NULL,NULL,1,0,1,NULL,NULL,'1','1','1','1','2015-12-06 21:44:17','2016-02-16 13:40:51',NULL,NULL,NULL),(10,10,'鱼子',5,7,NULL,'/fileupload/FiXeAFGvrXXXcwFZWqkVuror2qPF1454493991247.gif','挪威鱼子',NULL,NULL,NULL,'1','1',NULL,1,NULL,NULL,1,0,1,NULL,NULL,NULL,NULL,NULL,'1','2015-12-06 21:45:27','2016-02-16 13:40:51',NULL,NULL,NULL),(11,10,'生蚝',5,5,NULL,'/fileupload/FsaFK9r-MjvpxyM1hxffClRvbR2K1454494035959.gif','澳洲生蚝王',NULL,NULL,NULL,'1',NULL,NULL,1,NULL,NULL,1,0,1,NULL,NULL,NULL,NULL,NULL,'1','2015-12-06 21:46:37','2016-02-16 13:40:51',NULL,NULL,NULL),(12,10,'1',5,5,NULL,'/fileupload/01_m1449409582611.jpg','1',NULL,1.00,60.00,'1',NULL,NULL,1,NULL,NULL,1,1,1,NULL,NULL,NULL,NULL,NULL,'1','2015-12-06 21:47:23','2016-02-16 13:40:51',NULL,NULL,NULL),(13,10,'11',5,11,NULL,'/fileupload/01_m1449409766681.jpg','1',NULL,1.00,1.00,'1','1',NULL,1,NULL,NULL,1,1,1,NULL,NULL,NULL,NULL,NULL,'1','2015-12-06 21:49:47','2016-02-16 13:40:51',NULL,NULL,NULL),(14,10,'1',5,5,NULL,'/fileupload/6975397_dinggai2_thumb1449409918920.jpg','1',NULL,1.00,1.00,'1','1',NULL,1,NULL,NULL,1,1,1,NULL,NULL,NULL,NULL,NULL,'1','2015-12-06 21:52:09','2016-02-16 13:40:51',NULL,NULL,NULL);
