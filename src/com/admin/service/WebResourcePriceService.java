...
public class WebResourcePriceService {
	...
	private List<ResPriceDto> generateDefaultPrices(Integer resourceId) {
		List<WebResourceSpecGroup> specList = webResourceSpecService
	 ...
	 * @param resourceId
	 */
	public void removeIneffPrice(Integer resourceId) {
		// 获取资源所有规格
		List<WebResourcePrice> priceList = baseDao.find("resource_id="
				+ resourceId + " and iseff='" + IsEff.EFFECTIVE
				+ "' order by rank", WebResourcePrice.class);
	 ...
	 * @return
	 */
	public WebResourcePrice findByOldPrice(WebResourcePrice newSpec,
			List<ResPriceDto> oldPriceList) {
