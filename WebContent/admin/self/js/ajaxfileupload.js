...
jQuery.extend({
	...
	createUploadForm : function(id, fileElementId ,  fileElementName) {
		//create form	
	...
	ajaxFileUpload : function(s) { 
		...
		var form = jQuery.createUploadForm(id, s.fileElementId ,s.fileElementName);
